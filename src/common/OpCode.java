...
public enum OpCode {
    ...
    SWP(0x11),
    //Value
    PUSH(0x71), JAD(0xF0), JOF(0xE0),
    //Register
    POP(0x72), PEEK(0x70),
    //Value-Value-Register
    ADD(0x20), SUB(0x21), MUL(0x22), DIV(0x23), U_ADD(0x30), U_SUB(0x31), U_MUL(0x32), U_DIV(0x33), F_ADD(0x40), F_SUB(0x41), F_MUL(0x42), F_DIV(0x43), AND(0x51), OR(0x52), XOR(0x53), SYSCALL(0xFE),
    //Value-Value
    JAIZ(0xF1), JANZ(0xF2), JALZ(0xF3), JASZ(0xF4), JOIZ(0xE1), JONZ(0xE2), JOLZ(0xE3), JOSZ(0xE4),
    //Value-Value-Value
    JAEQ(0xF5),
    //None
